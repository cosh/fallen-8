...
namespace NoSQL.GraphDB.Test
{
    ...
    public class BigListUnitTest
    {
        ...
        public void BigList_SetValue_UnitTest()
        {
            ...
            var object25000000000 = new object();
            bigList.SetValue(25000000000, object25000000000);
            var object25000000000Actual = bigList.GetElement(25000000000);
            Assert.IsTrue(ReferenceEquals(object25000000000, object25000000000Actual));

            var object25000000001 = new object();
            bigList.SetValue(25000000001, object25000000001);
            var object25000000001Actual = bigList.GetElement(25000000001);
            Assert.IsTrue(ReferenceEquals(object25000000001, object25000000001Actual));
        }
    }
}
